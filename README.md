...
## Features
* Three seats
* Enclosed roof + reworked enemy protection
* Working gauge cluster (speedometer, tachometer, dashboard warning lights, etc)
* Functional side and center rear view mirror
